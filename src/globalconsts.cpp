...
std::shared_ptr<LookupTable> RED_MOVE_BOARD = std::make_shared<LookupTable>(std::initializer_list<std::vector<int>>{
	{4, 5},		//0
	{5, 6},
	{6, 7},
	{7, -1},
...
std::shared_ptr<LookupTable> RED_JUMP_BOARD = std::make_shared<LookupTable>(std::initializer_list<std::vector<int>>{
	{-1, 9},	//0
	{8, 10},
	{9, 11},
	{10, -1},
...
std::shared_ptr<LookupTable> BLACK_MOVE_BOARD = std::make_shared<LookupTable>(std::initializer_list<std::vector<int>>{
	{-1, -1},	//0
	{-1, -1},
	{-1, -1},
	{-1, -1},
...
std::shared_ptr<LookupTable> BLACK_JUMP_BOARD = std::make_shared<LookupTable>(std::initializer_list<std::vector<int>>{
	{-1, -1},	//0
	{1, -1},
	{-1, -1},
	{-1, -1},
...
std::shared_ptr<LookupTable> NN91_NODE_LOCATIONS = std::make_shared<LookupTable>(std::initializer_list<std::vector<int>>{
